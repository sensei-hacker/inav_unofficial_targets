...
timerHardware_t timerHardware[] = {
   DEF_TIM(TIM3,  CH1,  PB4,   TIM_USE_PPM,       0, 0 ),     // PPM IN
    ...
    DEF_TIM(TIM4,   CH1,  PB6,   TIM_USE_MC_MOTOR| TIM_USE_FW_SERVO,  0, 0 ),     // S3_OUT – D(1, 0, 2)
    DEF_TIM(TIM4,   CH2,  PB7,   TIM_USE_MC_MOTOR| TIM_USE_FW_SERVO,  0, 0 ),     // S4_OUT – D(1, 3, 2)
    DEF_TIM(TIM1,   CH1,  PA8,   TIM_USE_ANY,       0, 0),   //ANY
