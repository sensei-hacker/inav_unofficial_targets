...
// *************** LED & BEEPER **********************
// Status LEDs share SWD debug pins - only usable in release builds
#ifndef DEBUG_BUILD
...
#define BEEPER                  PC15
#define BEEPER_INVERTED         // Active-high via N-channel MOSFET (Q2)
...
// PC14 (OSC32_IN) used as SD card CS
#define USE_SDCARD
...
// UART2 has hardware SBUS inverter
#define SERIALRX_UART           SERIAL_PORT_USART2
#define SERIALRX_PROVIDER       SERIALRX_SBUS
#define DEFAULT_RX_TYPE         RX_TYPE_SERIAL

// PB10/PB11 shared with I2C2 - enable UART3 OR I2C2, not both
#define USE_UART3
...
// I2C2 shares PB10/PB11 with UART3 - enable one or the other
...
#define ADC_CHANNEL_3_PIN       PC5     // Shared with UART4_RX
