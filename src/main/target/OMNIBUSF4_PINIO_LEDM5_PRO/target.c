...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM8,  CH3, PC8,  TIM_USE_ANY,                 0, 0), // S5_IN // pad labelled CH5 on OMNIBUSF4
    DEF_TIM(TIM8,  CH4, PC9,  TIM_USE_ANY,                 0, 0), // S6_IN // pad labelled CH6 on OMNIBUSF4
...
#if (defined(OMNIBUSF4_PINIOPRO) || defined(OMNIBUSF4_PINIOV3)) && ! defined(OMNIBUSF4_PINIOV3_S6_SS) || defined(OMNIBUSF4_PINIOV3_S5S6_SS) || defined(OMNIBUSF4_PINIOV3_S5_S6_2SS))
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_SERVO,                0, 0), // S6_OUT
#elif defined(OMNIBUSF4_PINIOV3_S5S6_SS) || defined(OMNIBUSF4_PINIOV3_S5_S6_2SS)
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_ANY,                                                           0, 0), // S6_OUT SOFTSERIAL
#elif defined(OMNIBUSF4_PINIOV3_S6_SS)
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_ANY,                                                           0, 0), // S6_OUT SOFTSERIAL
#elif defined(OMNIBUSF4_PINIOPRO_LEDSTRIPM5)
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_SERVO,                0, 0), // S6_OUT
#else
    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_SERVO,                0, 0), // S6_OUT
#endif

#if (defined(OMNIBUSF4_PINIOPRO) || defined(OMNIBUSF4_PINIOV3)) && !defined(OMNIBUSF4_PINIOPRO_LEDSTRIPM5)
