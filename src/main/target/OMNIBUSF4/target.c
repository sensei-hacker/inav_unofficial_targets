...
#if defined(OMNIBUSF4ROVER)
    DEF_TIM(TIM3,  CH1, PA3,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR,               0, 0), // S3_OUT D1_ST6
    DEF_TIM(TIM3,  CH2, PA2,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR,               0, 0), // S4_OUT D1_ST1
#else
