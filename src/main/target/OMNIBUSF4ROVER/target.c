...
const timerHardware_t timerHardware[] = {
#if defined(OMNIBUSF4PRO) || defined(OMNIBUSF4V3) || defined(OMNIBUSF4ROVER) || defined(OMNIBUSF4V3_ROVER)
    ...
    DEF_TIM(TIM3,  CH3, PB0,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO,               0, 0), // S1_OUT D1_ST7
    ...
    DEF_TIM(TIM5,  CH2, PA1,  TIM_USE_FW_SERVO | TIM_USE_LED,  0, 0), // S5_OUT MOTOR, SERVO or LED
